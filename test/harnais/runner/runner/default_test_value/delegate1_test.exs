  ...
  test "ex_runner_map1: [:b]" do
    ...
    Harnais.Runner.run_tests_default_test_value(
      ...
      test_specs: [
        ...
        {:r, :equal?, [%{}], false},
        # v1.5 raises a BadMapError
        {{:e, BadMapError}, :equal?, [[]], false},
        ...
        {:r, :split, [[:b2]],
         {Map.take(@harnais_state_deep_b, [:b2]), Map.drop(@harnais_state_deep_b, [:b2])},
         @harnais_state_deep_b},
